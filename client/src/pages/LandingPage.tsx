...
const calculators = [
  {
    ...
    icon: "📊",
    tone: "from-blue-900/40 via-slate-900/50 to-slate-900/0",
  ...
  },
  {
    ...
    icon: "💳",
    tone: "from-purple-900/40 via-slate-900/50 to-slate-900/0",
  ...
  },
  {
    ...
    icon: "🎯",
    tone: "from-emerald-900/40 via-slate-900/50 to-slate-900/0",
  ...
  },
  {
    ...
    icon: "💰",
    tone: "from-amber-900/40 via-slate-900/50 to-slate-900/0",
  ...
  },
  {
    ...
    icon: "📈",
    tone: "from-cyan-900/40 via-slate-900/50 to-slate-900/0",
  ...
  },
  {
    ...
    icon: "🔄",
    tone: "from-rose-900/40 via-slate-900/50 to-slate-900/0",
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-200 overflow-x-hidden selection:bg-indigo-500/30">
      <PublicHeader />

      {/* Hero Background Elements */}
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-10 w-96 h-96 bg-blue-500/20 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-blob" />
        <div className="absolute top-0 right-10 w-96 h-96 bg-purple-500/20 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-blob animation-delay-2000" />
        <div className="absolute -bottom-32 left-20 w-96 h-96 bg-cyan-500/20 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-blob animation-delay-4000" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="py-20 lg:py-32 relative">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8 text-center lg:text-left animate-fade-in-up">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-900/30 text-sm font-semibold text-blue-300 border border-blue-800 shadow-sm backdrop-blur mx-auto lg:mx-0 transition-transform hover:scale-105">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl border border-slate-700 text-slate-200 font-semibold bg-slate-800/50 hover:bg-slate-800 backdrop-blur-sm transition-all hover:-translate-y-1 hover:shadow-md"
                  >
                    View Live Demo
                  </button>
                </div>

                <div className="grid grid-cols-3 gap-6 pt-8 border-t border-slate-800/60 max-w-xl mx-auto lg:mx-0">
                  {highlights.map((item) => (
              ...
              <div className="relative max-w-[600px] w-full mx-auto lg:mx-0 animate-fade-in-up animation-delay-500 perspective-1000">
                <div className="relative rounded-3xl border border-white/10 bg-slate-900/40 backdrop-blur-xl shadow-2xl shadow-blue-900/20 p-2 transform rotate-y-[-5deg] hover:rotate-y-0 transition-transform duration-700 ease-out">
                  <div className="rounded-2xl overflow-hidden bg-slate-900/90 shadow-inner">
                    ...
                    <div className="p-6 space-y-6">
                      ...
                      <div className="flex items-end justify-between">
                        <div>
                          <div className="text-sm font-medium text-slate-400 mb-1">Total Net Worth</div>
                          <div className="text-4xl font-black text-white tracking-tight">KES 1.2M</div>
                        </div>
                        <div className="text-emerald-500 bg-emerald-900/20 px-3 py-1 rounded-full text-sm font-bold animate-pulse">
                          ▲ 12.5%
                        </div>
                      </div>

                      {/* Chart */}
                      <div className="h-48 rounded-xl bg-gradient-to-b from-blue-900/10 to-transparent p-4 border border-blue-800/30">
                      ...
                      <div className="space-y-3">
                        ...
                        {[
                          { title: "Salary · KCB", amount: "+KES 62,100", icon: "💰", color: "text-emerald-500" },
                          { title: "Rent · Riverside", amount: "-KES 28,000", icon: "🏠", color: "text-white" },
                          { title: "Naivas Supermarket", amount: "-KES 5,400", icon: "🛒", color: "text-white" },
                        ].map((tx, i) => (
                          <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-slate-800/50 hover:bg-blue-900/20 transition-colors cursor-default group">
                            <div className="flex items-center gap-3">
                              <div className="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center shadow-sm text-lg group-hover:scale-110 transition-transform">
                                {tx.icon}
                              </div>
                              <span className="font-medium text-slate-200">{tx.title}</span>
                            </div>
          ...
          <section data-section="demo" className="py-24 relative overflow-hidden">
            <div className="mb-12 text-center max-w-2xl mx-auto">
              <span className="text-blue-400 font-bold tracking-wide uppercase text-sm">Live Preview</span>
              <h2 className="text-3xl md:text-5xl font-bold text-white mt-2 mb-4">See your money clearly.</h2>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {/* Main Chart Card */}
              <div className="lg:col-span-2 rounded-[2rem] bg-slate-900 border border-slate-800 p-8 shadow-2xl hover:shadow-blue-500/10 transition-shadow">
              ...
              {/* Accounts Card */}
              <div className="rounded-[2rem] bg-slate-800/50 border border-slate-800 p-8 flex flex-col justify-between">
                <div>
                  <h3 className="text-xl font-bold text-white mb-6">Your Accounts</h3>
                  <div className="space-y-4">
                    {accounts.map((acc) => (
                      <div key={acc.name} className="bg-slate-900 p-4 rounded-xl border border-slate-700 shadow-sm flex items-center justify-between hover:scale-[1.02] transition-transform cursor-pointer">
                        <div className="flex items-center gap-3">
                        ...
                        <div className="font-bold text-slate-300">{acc.balance}</div>
                      </div>
                    ))}
                  </div>
                </div>
                <AuthLink className="mt-8 w-full py-3 rounded-xl border-2 border-dashed border-slate-600 text-slate-400 font-semibold text-center hover:border-blue-500 hover:text-blue-500 transition-colors">
                  + Add New Account
                </AuthLink>
              </div>
            </div>
          ...
          <section className="py-24">
            <div className="mb-16 md:text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Financial Tools for Everyone</h2>
                ...
                >
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="text-2xl font-bold text-white mb-3">{calc.title}</h3>
                      <p className="text-slate-300 font-medium leading-relaxed mb-8">{calc.desc}</p>
                    </div>
                    <AuthLink className="inline-flex items-center font-bold text-white group-hover:gap-2 transition-all">
          ...
          <section className="py-24 max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {faqs.map((faq) => (
                <details key={faq.q} className="group rounded-2xl bg-slate-900 border border-slate-800 open:shadow-lg transition-shadow duration-300">
                  <summary className="flex items-center justify-between p-6 font-semibold text-lg text-white cursor-pointer select-none">
                    {faq.q}
                  ...
                  <div className="px-6 pb-6 text-slate-300 leading-relaxed animate-fade-in">
                    {faq.a}
                  </div>
                </details>
              ))}
          ...
          {/* Bottom CTA */}
          <section className="py-20">
            <div className="rounded-[2.5rem] bg-indigo-600 overflow-hidden relative shadow-2xl shadow-indigo-900/40 text-center px-6 py-20 lg:px-20 lg:py-24">
              {/* Background patterns */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <AuthLink className="bg-white text-indigo-700 px-10 py-4 rounded-2xl font-bold text-lg hover:shadow-xl hover:scale-105 transition-all">
                    Create Free Account
                  </AuthLink>
                </div>
                <p className="mt-8 text-indigo-200 text-sm">No credit card required · Free forever plan available</p>
              </div>
            </div>
          </section>
