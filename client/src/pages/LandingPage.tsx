    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950">
      ...
      <main className="flex-1 relative z-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <section className="py-14 md:py-20">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-white/5 text-sm font-semibold text-blue-800 dark:text-blue-100 border border-white/50 dark:border-white/10 shadow-sm backdrop-blur mx-auto lg:mx-0">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-1 justify-center lg:justify-start">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-slate-200/80 dark:border-white/15 text-slate-900 dark:text-white font-semibold bg-white/80 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 shadow-sm backdrop-blur transition-all"
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 max-w-xl mx-auto lg:mx-0">
                  {highlights.map((item) => (
                    <div
                      key={item.label}
                      className="rounded-2xl border border-white/50 dark:border-white/10 bg-white/80 dark:bg-white/5 backdrop-blur px-4 py-4 shadow-sm text-center"
                    >
              ...
              <div className="relative max-w-xl w-full mx-auto lg:mx-0">
                <div className="rounded-3xl border border-white/60 dark:border-white/10 bg-white/85 dark:bg-white/5 shadow-2xl shadow-blue-900/20 backdrop-blur-xl p-6 space-y-5">
                  ...
                  <div className="rounded-2xl border border-white/50 dark:border-white/10 bg-white/80 dark:bg-white/0 backdrop-blur p-4 shadow-sm">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div
                          key={tx.title}
                          className="flex items-center justify-between rounded-xl border border-white/40 dark:border-white/10 bg-white/80 dark:bg-white/5 backdrop-blur px-3 py-2"
                        >
          ...
          <section data-section="demo" className="py-16 md:py-20 border-t border-white/50 dark:border-white/5">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-10">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-white/5 border border-white/60 dark:border-white/10 text-sm text-slate-700 dark:text-white/80 backdrop-blur">
                Live demo · No sign-up needed
              </div>
            </div>

            <div className="grid gap-6 lg:grid-cols-3">
              <div className="lg:col-span-2 rounded-3xl bg-white/80 dark:bg-white/5 border border-white/60 dark:border-white/10 p-6 shadow-xl shadow-blue-900/15 backdrop-blur-md">
              ...
              <div className="space-y-4">
                <div className="rounded-3xl bg-white/80 dark:bg-white/5 border border-white/60 dark:border-white/10 p-6 shadow-xl shadow-blue-900/15 backdrop-blur-md">
                  ...
                  <div className="space-y-3">
                    {accounts.map((acc) => (
                      <div
                        key={acc.name}
                        className="flex items-center justify-between p-3 rounded-xl bg-white/90 dark:bg-white/5 border border-white/60 dark:border-white/10 shadow-sm"
                      >
                        <div>
          ...
          <section className="py-16 md:py-20 border-t border-white/50 dark:border-white/5">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-10">
              <div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {faqs.map((faq) => (
                  <details
                    key={faq.q}
                    className="group rounded-2xl border border-white/60 dark:border-white/10 p-5 bg-white/85 dark:bg-white/5 backdrop-blur shadow-sm"
                  >
